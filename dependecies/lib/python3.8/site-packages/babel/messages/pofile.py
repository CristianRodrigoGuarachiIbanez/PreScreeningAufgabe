...
def read_po(fileobj, locale=None, domain=None, ignore_obsolete=False, charset=None, abort_invalid=False):
    ...
    (u'foo %(name)s', u'quux %(name)s')
      ([(u'pre_screening_aufgabe.py', 1)], [u'fuzzy', u'python-format'])
      ([], [])
    ((u'bar', u'baz'), (u'bar', u'baaz'))
      ([(u'pre_screening_aufgabe.py', 3)], [])
...
def write_po(fileobj, catalog, width=76, no_location=False, omit_header=False,
    ...
    >>> catalog = Catalog()
    >>> catalog.add(u'foo %(name)s', locations=[('pre_screening_aufgabe.py', 1)],
    ...             flags=('fuzzy',))
    <Message...>
    >>> catalog.add((u'bar', u'baz'), locations=[('pre_screening_aufgabe.py', 3)])
    <Message...>
